...
# Secure config (in practice, load from external YAML file)
config = {
    'credentials': {
        'usernames': {
            'admin': {
                ...
                'name': 'Admin User',
                'password': '$2b$12$eIXoD9FHTU1v.ZD7wV6o1O2cJhTb0tSGOwbg.VA89ktmY8owEQFj6'  # Hashed
            }
        }
    },
    'cookie': {
...
# 👇 Corrected login call with keyword argument
